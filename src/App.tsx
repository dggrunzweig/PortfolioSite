      ...
      <div className="app">
        ...
        <PortfolioItem
          ...
          description={[
            ...
            "The following is a selection of digital design artifacts intended to represent my skillset and design taste. All projects were built using ReactJS with vanilla Typescript and CSS, no external libraries or React packages were used. Desktop and Mobile friendly.",
            "",
          ]}
          children={null}
          image_urls={[
