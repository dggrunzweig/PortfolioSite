  ...
  return (
    <div className="about-div">
      ...
      <div className="body about-body">
        ...
        <br />
        An algorithmic audiovisual artwork. Released with ArtBlocks in 2023 as a
        longform series of 200. Built with web audio, three.js and glsl. Created
        in collaboration with Johan Ismael.
        <br />
        <br />
        <a
        ...
        of 50. Built with web audio, three.js and glsl. Created in collaboration
        with Johan Ismael.
        <br />
        <br />
        <a
        ...
        of dancefloors, and reverence for the ever-changing beauty of the world.
        Released in 2020 on Silent Season. Created in collaboration with Johan
        Ismael.
        <br />
        <br />
        <a href="https://tapeghost.bandcamp.com/album/mobius" className="link">
          mobius
        </a>
        <br />
