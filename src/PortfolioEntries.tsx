...
export const portfolio_entries = [
  createEntry(
    ...
    />,
    "I enjoy reading articles by musicians who write about their process on platforms like Substack and Medium. However, most blogging platforms weren't designed for writers who would need to showcase sounds as an essential part of their work. As a result, the audio experience on these sites can lack polish and intention. In general, audio player widgets tend to direct us towards a passive relationship with listening that is emblematic of the era of digital convenience.",
  ...
  createEntry(
    ...
    "The primary challenge of this project was automatically reordering tasks based on multiple data conditions. I created a typescript interface to define tasks and wrote a custom sorting function which operated on the array of tasks stored by the table. Each time a user interacts with a task, changing its priority or status, the table should automatically update the ordering.",
